...
export class HttpInterceptorInterceptor implements HttpInterceptor {
  ...
  loginUrl: string = environment.apiAuthUrl + '/auth/login';
  currentUserUrl: string = environment.apiAuthUrl + '/auth/current';
  logoutUrl: string = environment.apiAuthUrl + '/auth/logout';
